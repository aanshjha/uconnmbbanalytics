# Historical Findings — April 2026
...
> **Withdrawn historical findings (September 16, 2026).** The April output below contains duplicate-inflated scout totals and invalid pregame evaluation claims. It is retained as an audit record, not current evidence. See [source reconciliation and corrected results](../RELIABILITY_RESET.md). Lineup recommendations remain unreleased; the corrected model does not beat the expanding-mean baseline.

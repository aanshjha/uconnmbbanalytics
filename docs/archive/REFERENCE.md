# Historical Technical Reference — April 2026
...
> **Historical reference.** Source contracts and validation claims below predate the reliability reset. Use [the current reconciliation and pilot guide](../RELIABILITY_RESET.md) for released outputs and run instructions.
...
0. `SUBMISSION_BRIEF.md` for the concise rubric-mapped write-up.
...
![Probability Calibration Curve](../images/uconn_pred_pr_net_pos_calibration_curve.png)

![Game-Level Defensive Leak Trend](../images/uconn_game_level_def_leak_trend.png)
